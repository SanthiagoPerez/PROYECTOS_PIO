...
$(document).ready(function(){
    ...
    $('#registroForm').on('submit', function(event){
        ...
        if ($(this).parsley().isValid()){ // si la validación del formulario es valida o correcta
            //OJO abre la consola en el inspeccionador de la WEB para que veas lo que te muestra

            // Creo una constante para capturar el valor del nro documento del input de entrada de datos
